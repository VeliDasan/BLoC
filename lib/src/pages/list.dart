                    ...
                    return StreamBuilder(
                        ...
                        builder: (context, vehicleSnap) {
                          if (vehicleSnap.hasData &&
                              ...
                              vehicleSnap.data!.docs.isNotEmpty) {

                            context.read<ListBloc>().add(UpdateVehicleList(
                              plates: vehicleSnap.data!.docs.map((e) => e['plate'] as String).toList(),
                              vehicleDetails: vehicleSnap.data!.docs.map((e) => e.data()).toList(),
                            ));
